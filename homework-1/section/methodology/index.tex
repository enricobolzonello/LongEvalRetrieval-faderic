...
\begin{itemize}
    \item \textbf{\texttt{DirectoryIndexer}}: \input{section/methodology/index/DirectoryIndexer}
    \\
    \item \textbf{\texttt{BodyField}}: \input{section/methodology/index/BodyField}
\end{itemize}
